...
import com.adlots.androidapp.helper.CirclePageIndicator;
import com.adlots.androidapp.helper.PageIndicator;
        ...
        public Fragment getItem(int position) {
            try{
                switch(position){
                    ...
                    case 5:
                        return TutorialSixthPage.newProduction(position);
                    default:
                        return null;
                }
            }
